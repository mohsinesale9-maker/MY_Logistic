...
const formFields = [
  ...
  { key: "payeur", label: "Fournisseur", type: "text" },
...
const filterFn = (item) => item.type === "fournisseur";

export default function SupplierPayments() {
  return (
    <CrudPage
      entityName="Payment"
      title="Suivi Paiements Fournisseurs"
      subtitle="Règlements des factures fournisseurs"
      columns={columns}
      formFields={formFields}
      filterFn={filterFn}
      onTransform={(data) => ({ ...data, type: "fournisseur" })}
